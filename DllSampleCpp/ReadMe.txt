...
・リソースビュー>DllSampleCpp.rc>Dialog>"IDD_DLLSAMPLECPP_DIALOG"←これ

これらのファイルが主な編集ファイルになる
...
================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: DllSampleCpp プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した DllSampleCpp には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには DllSampleCpp アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

DllSampleCpp.vcxproj
...
DllSampleCpp.h
   ...
   CDllSampleCppApp アプリケーション クラスを宣言します。

DllSampleCpp.cpp
   これは、アプリケーション クラス CDllSampleCppApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\DllSampleCpp.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル DllSampleCpp.rc に含まれていま
   す。

res\DllSampleCpp.rc2
...
DllSampleCppDlg.h, DllSampleCppDlg.cpp - ダイアログ
   これらのファイルは CDllSampleCppDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な DllSampleCpp.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   DllSampleCpp.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
